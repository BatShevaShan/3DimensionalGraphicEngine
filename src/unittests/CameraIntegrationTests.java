...
class CameraIntegrationTests {
    ...
    public void cameraRayPlaneIntegration() {
        ...
        assertCountIntersections(cam, new Plane(new Vector(0, 0, 1), new Point3D(0, 0, -5)), 9);

        // TC02: Plane with small angle 9 points
        assertCountIntersections(cam, new Plane(new Vector(0, 1, 2), new Point3D(0, 0, -5)), 9);

        // TC03: Plane parallel to lower rays 6 points
        assertCountIntersections(cam, new Plane(new Vector(0, 1, 1), new Point3D(0, 0, -5)), 6);
